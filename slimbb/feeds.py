...
class LastPosts(ForumFeed):
    ...
    title_template = 'slimbb/feeds/posts_title.html'
    description_template = 'slimbb/feeds/posts_description.html'
...
class LastTopics(ForumFeed):
    ...
    title_template = 'slimbb/feeds/topics_title.html'
    description_template = 'slimbb/feeds/topics_description.html'
