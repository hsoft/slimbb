...
class Forum(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('slimbb:forum', args=[self.id])
...
class Topic(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('slimbb:topic', args=[self.id])
...
class Post(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('slimbb:post', args=[self.id])
...
class Attachment(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('slimbb:forum_attachment', args=[self.hash])
